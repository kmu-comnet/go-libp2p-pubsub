...
const (
	PropagationType_UNKNOWN    PropagationType = 0
	PropagationType_EAGER_PUSH PropagationType = 1
	PropagationType_LAZY_PULL  PropagationType = 2
)

var PropagationType_name = map[int32]string{
	0: "UNKNOWN",
	1: "EAGER_PUSH",
	2: "LAZY_PULL",
}

var PropagationType_value = map[string]int32{
	"UNKNOWN":    0,
	"EAGER_PUSH": 1,
	"LAZY_PULL":  2,
}
...
func (x PropagationType) String() string {
	return proto.EnumName(PropagationType_name, int32(x))
}

func (x *PropagationType) UnmarshalJSON(data []byte) error {
	value, err := proto.UnmarshalJSONEnum(PropagationType_value, data, "PropagationType")
	if err != nil {
		return err
	}
	*x = PropagationType(value)
	return nil
}
...
type Message struct {
	...
	PropaType            *PropagationType `protobuf:"varint,7,opt,name=propaType,enum=pubsub.pb.PropagationType" json:"propaType,omitempty"`
	HopCount             *uint32          `protobuf:"varint,8,opt,name=hopCount" json:"hopCount,omitempty"`
	XXX_NoUnkeyedLiteral struct{}         `json:"-"`
	XXX_unrecognized     []byte           `json:"-"`
	XXX_sizecache        int32            `json:"-"`
}
...
func (m *Message) GetPropaType() PropagationType {
	if m != nil && m.PropaType != nil {
		return *m.PropaType
	}
	return PropagationType_UNKNOWN
}

func (m *Message) GetHopCount() uint32 {
...
func init() {
	proto.RegisterEnum("pubsub.pb.PropagationType", PropagationType_name, PropagationType_value)
...
var fileDescriptor_77a6da22d6a3feb1 = []byte{
	...
	,
}
...
func (m *Message) MarshalToSizedBuffer(dAtA []byte) (int, error) {
	...
	if m.HopCount != nil {
		i = encodeVarintRpc(dAtA, i, uint64(*m.HopCount))
		i--
		dAtA[i] = 0x40
	}
	if m.PropaType != nil {
		i = encodeVarintRpc(dAtA, i, uint64(*m.PropaType))
		i--
		dAtA[i] = 0x38
	}
	if m.Key != nil {
...
func (m *Message) Size() (n int) {
	...
	if m.PropaType != nil {
		n += 1 + sovRpc(uint64(*m.PropaType))
	}
	if m.HopCount != nil {
		n += 1 + sovRpc(uint64(*m.HopCount))
	}
	if m.XXX_unrecognized != nil {
		n += len(m.XXX_unrecognized)
	}
	...
	for iNdEx < l {
		...
		case 7:
			...
			for shift := uint(0); ; shift += 7 {
				...
				b := dAtA[iNdEx]
				iNdEx++
				v |= PropagationType(b&0x7F) << shift
				if b < 0x80 {
					break
				}
			}
